...
async def start(client, message):
          ...
          await message.reply_text(text =f"Hello **{message.from_user.first_name }** \n\n __I am simple Google Translater Bot \n I can translate any language to you selected language__",reply_to_message_id = message.message_id , parse_mode="markdown", reply_markup=InlineKeyboardMarkup(            [                [                    InlineKeyboardButton("News Channel" ,url="https://t.me/SL_MGx03") ],                 [InlineKeyboardButton("Subscribe ", url="https://youtu.be/5l00eTxj_LY"),InlineKeyboardButton("Team",url = "https://t.me/Danuma01") ]           ]        ) )
